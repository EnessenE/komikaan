...
### Added
- /feeds/names
- /feeds/realtime-names
- /feeds/delays/top
- /stops/train-stations
- Map controller features to allow more specific exploring
...
[2.17.1] - 18-01-2025
### Changed
- Start and end times for alerts
- Update komikaan.GTFS 4.2.0 > 4.4.1

[2.17.0] - 11-01-2025
### Added
- feeds/coverage endpoint showing coverage
### Changed
- Some renaming of models
...
[2.16.1] - 06-01-2025
### Added
- Support retrieving StartFrom, StartsBefore, EndsAt

[2.16.0] - 04-01-2025
### Added
- Get alerts from a stop

[2.15.0] - 28-12-2025
### Added
- Load credits data into Feeds

[2.14.0] - 28-12-2025
### Added
- Added /exact/{dataOrigin}/{stopId} allowing for searching for specific stops
### Changed
- Code cleanup
